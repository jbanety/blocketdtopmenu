...
if (!class_exists('RokNavMenu'))
{
    class RokNavMenu extends RokMenu
    {
        ...
        {
            require_once(dirname(__FILE__) . '/providers/RokMenuProviderPrestashop.php');
            return new RokMenuProviderPrestashop($this->args);
        }
        ...
        public static function loadCatalogs()
        {
            if (!self::$catalogs_loaded) {
				...
				require_once(dirname(__FILE__) . '/etdprestashop/catalog.php');
